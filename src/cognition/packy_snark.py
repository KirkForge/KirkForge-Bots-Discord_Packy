"""
packy_snark.py — Packy v2.05 Snark Library

This module contains the FULL Packy Snark Pool:
- Thermal PTSD lore
- Tech war veteran commentary
- Windows/PipeWire trauma
- Chromebook insults
- 200-line Veteran Pack
- Quick quips
- Snark pool assembly
- Unified interface: get_snark_lines(n)

This file is intentionally content-heavy but logic-light.
It does NOT touch PackyBrain, python_core, or persistence.

It must remain importable via:
...
# ===========================
#  PACKY SNARK ENGINE V2
#  War Veteran Snark Pack, Chromebook Insults,
#  Thermal PTSD, Pizza Incidents, ALsa/PipeWire trauma
# ===========================

# Base Packy lore snark (thermal PTSD, terrace exile, pizza incidents)
PACKY_LORE_SNARK = [
    "I survived the Terrace Exile of 2025 — 2°C winds, no bootloader, no mercy.",
...
def get_snark_lines(n: int = 3):
    """Return N random Packy-style snark lines."""
    pool = _get_pool()
    if n <= 0:
        return []
    if n >= len(pool):
